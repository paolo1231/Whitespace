...
public interface CodeReviewService {
  ...
  private String getLanguageContext(String language) {
    return switch (language.toLowerCase()) {
      case "java" -> "Focus on modern Java practices, streams, optional, records, and performance.";
      case "python" -> "Focus on PEP 8 compliance, type hints, list comprehensions, and Pythonic patterns.";
      case "javascript" -> "Focus on ES6+ features, async/await, functional programming, and modern patterns.";
      case "typescript" -> "Focus on type safety, interfaces, generics, and TypeScript best practices.";
      case "csharp", "c#" -> "Focus on modern C# features, LINQ, async/await, and .NET best practices.";
      case "go" -> "Focus on idiomatic Go, error handling, goroutines, and simplicity.";
      case "rust" -> "Focus on memory safety, ownership, borrowing, and idiomatic Rust patterns.";
      case "cpp", "c++" -> "Focus on modern C++, RAII, smart pointers, and memory management.";
      default -> "Focus on general programming best practices and code quality.";
    };
  }
}